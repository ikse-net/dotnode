...
else if ($user = $this->GetUser())
{
	...
	<table>
		...
		<tr>
			...
			<td><input name="email" value="<?php echo  htmlentities($user["email"], ENT_COMPAT, 'UTF-8') ?>" size="40" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input name="changescount" value="<?php echo  htmlentities($user["changescount"], ENT_COMPAT, 'UTF-8') ?>" size="40" /></td>
		</tr>
		<tr>
			<td align="right">Nombre maximum de versions :</td>
			<td><input name="revisioncount" value="<?php echo  htmlentities($user["revisioncount"], ENT_COMPAT, 'UTF-8') ?>" size="40" /></td>
		</tr>
		<tr>
			<td align="right">Votre devise :</td>
			<td><input name="motto" value="<?php echo  htmlentities($user["motto"], ENT_COMPAT, 'UTF-8') ?>" size="40" /></td>
		</tr>
		<tr>
			<td></td>
