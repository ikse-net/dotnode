...
{t}Your login to .node is{/t} : <b>{$smarty.session.my_login}</b> <br />
<br />
{literal}
...
<form action='/action/new/record' method='post' enctype="multipart/form-data">
<div id='tabcontent' class='even' style='border: 1px silver solid'>
<div id='step0'>
...
<p>{t}Now, you can connect to .node network{/t}.</p>
<p>{t}Thanks for your participation{/t}.</p>
<p>{t}This filled profile is basic, a more detailled profile can be filled inside the network (menu: Home / Profile){/t}</p>
