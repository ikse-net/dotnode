...
<tr class='{cycle values='odd,even'}'><td align='right' class='label'>{t}Favorite TV shows{/t} : </td><td class='value'><textarea name='favorite_tvshow' rows='5' cols='36'>{$my.interests.favorite_tvshow|escape}</textarea></td></tr>
