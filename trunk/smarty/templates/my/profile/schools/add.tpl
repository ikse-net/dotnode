...
<form action='/action/my/profile/schools/add' method='post'>
<table>
...
<tr class='{cycle values='odd,even'}'><td align='right' class='label'>{t}Country{/t} : </td><td class='value'>{html_options name='country' options=$labels.profile.country selected=$my.schools.contry}</td></tr>
<tr class='{cycle values='odd,even'}'><td colspan='2' align='center'><input type='submit' value='{t}Add{/t}'><td></tr>
</table>
</form>
</div>
